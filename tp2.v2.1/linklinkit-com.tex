...
O(longitud (lli.arrayCatLinks[idAC(lli.dameAcat,c)-1])). Luego creamos otro itPuntLinks, itP1, esta vez usando la fecha f1 en O(|c|).
...
\par\textbf{OrdenTotal:} \textbf{O(longitud(lli.arrayCatLinks[idAC(lli.dameAcat,c)-1] + |c|)}
