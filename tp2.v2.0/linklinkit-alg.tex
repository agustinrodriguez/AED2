...
\begin{algorithmic}[1]
\Function{icategoriasLLI}{\param{in}{lli}{estrLLI}}{$\ensuremath{\rightarrow}$ \param{}{res}{acat}}
...
\caption{iLinksLLI}
\begin{algorithmic}[1]
\Function{ilinksLLI}{\param{in}{lli}{estrLLI}}{$\ensuremath{\rightarrow}$ \param{}{res}{itLista(datosLink)}}
...
\while{c $\leq$ \#categoriasAC(ac)} \hfill //O(\#categoriasAC(ac))
