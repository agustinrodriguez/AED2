...
$\hspace*{6mm}$ res = \IF\ c = ac.raiz THEN true ELSE {\IF\ h $\in$ (obtener(c,ac.familia)).hijos THEN true ELSE {\IF\ (obtener(h,ac.familia)).abuelo $\in$ (obtener(c,ac.familia)).hijos THEN true ELSE COMO HAGO RECURSION ACA? FI } FI } FI
